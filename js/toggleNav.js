...
$(document).ready(function() { // Attente du chargement complet du DOM
    ...
    $(".m-nav-toggle").click(function(e) {
        e.preventDefault(); // La méthode preventDefault() de cet objet permet d’empêcher le navigateur de déclencher son comportement par défaut.(Dans ce cas-ci il n'est pas d'une grande utilité)
        $(".m-nav-toggle").toggleClass("open"); // Animation des barres de l'hamburger.
        $(".m-right").toggleClass("open"); // Animation de la navbar.
    })
