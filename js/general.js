...
var mapVelov = document.getElementById("map");
...
// Création de la carte avec l'objet carte, "mapVelo.initCarte" est appelée dans index.html
var mapVelo = Object.create(MapLyon);
...
ajaxGet("https://api.jcdecaux.com/vls/v1/stations?contract=Lyon&apiKey=029ff2b237a92454caa9c28df5d7753ffd3c2af7", function(reponse) {
    ...
    allStation.forEach(function(station) { /*"forEach()" appele une fois pour chaque élément présent dans le tableau.*/
        ...
        mapVelo.initMarker(station);
    });
    //Regroupement des markers
    mapVelo.initClustering();
});